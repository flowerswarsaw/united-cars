...
export default function TeamsPage() {
  ...
  return (
    <AppLayout user={user}>
      <PageHeader
        title="CRM Teams"
        description="Manage team structure and member assignments"
        breadcrumbs={[
          { label: 'CRM', href: '/crm' },
          { label: 'Teams' }
        ]}
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">
              {teams.reduce((sum, t) => sum + (t.memberships?.length || 0), 0)}
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">Teams with Leaders</CardTitle>
          </CardHeader>
          <CardContent>
